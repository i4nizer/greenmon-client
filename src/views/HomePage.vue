        ...
        <v-app-bar class="border-b bg-green" elevation="0">
            ...
            <template #append>
                ...
                <v-btn
                    ...
                    to="/auth/sign-in"
                    text="Sign In"
                    class="bg-white ml-1 mr-4 mr-md-6"
                ></v-btn>
            </template>
        </v-app-bar>
            ...
            <v-container class="pa-0" fluid>
                <v-row class="bg-green-lighten-5 py-5 px-5 px-md-8 px-lg-10" align="center">
                    <v-col cols="12" sm="12" md="6">
                        ...
                        <p class="text-grey-darken-2 mt-5">Unlock the power of the Internet of Things with our comprehensive platform. Connect devices, analyze data, and automate processes to drive innovation and efficiency.</p>
                        <v-btn
                            link
                            to="/auth/sign-up"
                            size="large"
                ...
                <v-row class="bg-white px-5 px-md-8 px-lg-10 my-0" style="min-height: 100dvh;" align="center">
                    <v-col cols="12" sm="12" md="6">
                        ...
                        <p class="text-grey-darken-2 mt-5">Revolutionary AI-powered camera system that automatically detects nutrient deficiencies in lettuce crops, enabling farmers to take immediate action and optimize yield quality.</p>
                        ...
                        <v-list>
                            ...
                            <v-list-item>
                                ...
                                <div class="pl-4">
                                    ...
                                    <p class="text-grey">The machine learning model then processes the image containing lettuce to check for nutrient deficiencies.</p>
                                </div>
                            </v-list-item>
                            <v-list-item>
                                <template #prepend>
                                ...
                                <div class="pl-4">
                                    ...
                                    <p class="text-grey">Once deficiencies are found, the user is alerted with the image and given recommendations to solve the deficiency.</p>
                                </div>
                            </v-list-item>
                        </v-list>
                        <v-btn
